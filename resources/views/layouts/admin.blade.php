                        ...
                        <div class="center">
                            ...
                            <div class="center-item">
                                <ul class="menu-list">
                                    ...
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                            <div class="icon"><i class="icon-warehouse"></i></div>
                                            <div class="text">Warehous</div>
                                        </a>
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.warehouse.add') }}" class="">
                                                    <div class="text">New Warehouse</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                    ...
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0);" class="menu-item-button">
                                            <div class="icon"><i class="icon-inventory"></i></div>
                                            <div class="text">Inventory</div>
                                        </a>
                                        <ul class="sub-menu">
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.inventory.add') }}" class="">
                                                    <div class="text">New Inventory</div>
                                                </a>
                                            </li>
                                            <li class="sub-menu-item">
                                                <a href="{{ route('admin.inventories') }}" class="">
                    ...
                    <div class="section-content-right">
                        ...
                        <div class="main-content">
                            ...
                            <div class="bottom-page">
                                <div class="body-text">Copyright © 2024 BL3T</div>
                            </div>
                        </div>
                    </div>
                </div>
