                    ...
                    <div class="col-lg-12">
                        <div class="page-content my-account__edit">
                            <div class="my-account__edit-form">
                                <form name="account_edit_form" action="{{ route('admin.change.settings') }}" method="POST" enctype="multipart/form-data" class="form-new-product form-style-1 needs-validation" novalidate="">
                                    @csrf
                                    @method('PUT')
                                    <fieldset class="name">
                                    ...
                                    <fieldset class="name">
                                        ...
                                        <input class="flex-grow" type="text" placeholder="Mobile Number"
                                               name="phone" tabindex="0" value="{{ $user->phone_number }}" aria-required="true"
                                               required="">
                                    </fieldset>
                                    @error('phone')
                                    <span class="alert alert-danger text-center">
